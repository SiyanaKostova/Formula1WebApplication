...
namespace Formula1WebApplication.Infrastructure.Migrations
{
    ...
    [Migration("20240410194539_UserClaimsConfigurationCreated")]
    partial class UserClaimsConfigurationCreated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Formula1WebApplication.Infrastructure.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2dfd3144-5e15-4d45-9318-932e821bac27",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAECZwhrL3YvSIQ1+x93yCdvSG/pZhIDCv0SP7OwfWfUmmJ7hFtkzbLIdEiIUwonG2yw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "8732ecc7-f3fc-4b4a-a278-8f894fd628b9",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4fe1e6ba-13f5-435b-a146-f756c1e7a274",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEDxVzSY1xUN+8cG1Q81eqjmueqpuAf8MyV8/QM3nnBZBBWXArNjeBTzwFmLcB2DBAA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "b5197083-eafd-4a58-9fe2-598f974d9f2a",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "467fbf77-a911-48c3-9eb5-31b6547a6fa9",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAENngDifDGvPTfHzkd53N/Nd97A2vuthxmSmiHSFjkg+C3usm/j5IXSeo6pffypi4iA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "d56d8b5b-9aed-4e11-b523-3b926035f77c",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Formula1WebApplication.Infrastructure.Data.Models.EventUser", b =>
                {
            ...
            modelBuilder.Entity("Formula1WebApplication.Infrastructure.Data.Models.EventUser", b =>
                {
                    b.HasOne("Formula1WebApplication.Infrastructure.Data.Models.Event", "Event")
                        .WithMany("EventUsers")
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Formula1WebApplication.Infrastructure.Data.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Formula1WebApplication.Infrastructure.Data.Models.Organizer", b =>
                {
                    b.HasOne("Formula1WebApplication.Infrastructure.Data.Models.ApplicationUser", "User")
                        .WithOne("Organizer")
                        .HasForeignKey("Formula1WebApplication.Infrastructure.Data.Models.Organizer", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Formula1WebApplication.Infrastructure.Data.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
